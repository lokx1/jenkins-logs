...
int main() {
    ...
    printf("Test Case 3: power(1, 10) = %d\n", power(1, 10)); // Expected output: 1
    printf("Test Case 4: power(0, 5) = %d\n", power(0, 5)); // Expected output: 0
    printf("Test Case 5: power(3, 4) = %d\n", power(3, 4)); // Expected output: 81
    printf("Test Case 6: power(-2, 3) = %d\n", power(-2, 3)); // Expected output: -8
    printf("Test Case 7: power(-2, 2) = %d\n", power(-2, 2)); // Expected output: 4
    printf("Test Case 8: power(2, -2) = %d\n", power(2, -2)); // Expected output: 1 (since exp is non-negative)
    return 0;
}
