...
int main() {
    ...
    // Delete node with key = 7 (last remaining element)
    deleteNode(&head, 7);
    ...
    deleteNode(&head, 10);
    printf("Linked list after attempting to delete non-existing key 10: ");
    printList(head);

    // Insert new nodes
    insertAtBeginning(&head, 15);
    insertAtBeginning(&head, 10);
    printf("Linked list after inserting 15 and 10: ");
    printList(head);
